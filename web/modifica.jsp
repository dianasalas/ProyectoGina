...
<html>
    ...
    <body>
        ...
        %>
         <form action="modifdatos.jsp" method="post">
        <table>  
            <%
                ...
                for (i=0; i<lista.size(); i++){
                   ...
                   byte[] imagen = lista.get(i).getImagen();
                    ...
                    <tr>
                        ...
                        <td>
                            ¿Desea modificarlo?: <input type="radio" name="articulo" value="<%=lista.get(i).getNombre()%>">
                        </td>
      ...
      <!--  <div id="der">
          <iframe name="iframe" height="1000" width="700">
            </iframe>
        </div>
    -->
